...
execute_process(
  COMMAND "/usr/bin/git" show-ref "db8a5cfd4dda452c10d8d4e30fa3406c1ae38a94"
  WORKING_DIRECTORY "/Users/breastcad/Downloads/SegmentationsTool/build/slicersources-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "db8a5cfd4dda452c10d8d4e30fa3406c1ae38a94")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("db8a5cfd4dda452c10d8d4e30fa3406c1ae38a94" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/db8a5cfd4dda452c10d8d4e30fa3406c1ae38a94")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/breastcad/Downloads/SegmentationsTool/build/slicersources-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/breastcad/Downloads/SegmentationsTool/build/slicersources-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
